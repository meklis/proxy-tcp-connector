...
import (
	...
	"github.com/meklis/proxy-tcp-connector/binder"
	"github.com/meklis/proxy-tcp-connector/config"
	"github.com/meklis/proxy-tcp-connector/poller"
	"github.com/meklis/proxy-tcp-connector/structs"
...
func parseCommand(b []byte) (err error, command CommandType, argument interface{}) {
	...
	case CONN:
		...
		return nil, CONN, &structs.Device{
			Port: Port,
			Ip:   Ip,
		}
	case CONN_LIST:
